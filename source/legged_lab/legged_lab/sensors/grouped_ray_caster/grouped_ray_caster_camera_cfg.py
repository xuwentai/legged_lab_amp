...
class GroupedRayCasterCameraCfg(GroupedRayCasterCfg):
    ...
    noise_pipeline: list[dict] | None = None
    """Image processing pipeline used to create noised camera outputs."""

    data_histories: dict[str, int] = {}
    """History buffer lengths for output data types, e.g. {"distance_to_image_plane_noised": 37}."""
