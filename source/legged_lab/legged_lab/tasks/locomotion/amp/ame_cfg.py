...
G1_ROUGH_HEIGHT_SCAN_MODE = "depth"

if G1_ROUGH_HEIGHT_SCAN_MODE not in {"xyz", "z", "depth"}:
    raise ValueError("G1_ROUGH_HEIGHT_SCAN_MODE must be either 'xyz', 'z', or 'depth'.")

G1_AME_SCAN_RESOLUTION = 0.04
G1_AME_SCAN_SIZE = (0.4, 0.4)
G1_AME_SCAN_POSITION_OFFSET = (0.2, 0.0, 20.0)
G1_AME_HEIGHT_OFFSET = 0.5
G1_AME_MAP_SCAN_DIM = (18, 32, 1) if G1_ROUGH_HEIGHT_SCAN_MODE == "depth" else (
    11,
    11,
    3 if G1_ROUGH_HEIGHT_SCAN_MODE == "xyz" else 1,
)
G1_AME_MAP_SCAN_HISTORY_LENGTH = 4 if G1_ROUGH_HEIGHT_SCAN_MODE == "depth" else 1
