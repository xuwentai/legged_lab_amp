...
This is the non-deprecated entry point used by
``./isaaclab.sh play --rl_library rsl_rl --task <TASK>``.
For direct invocation, prefer ``play.py`` (which also works, just with a
DeprecationWarning).
"""
